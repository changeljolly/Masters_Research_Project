...
python  ${path}/src/Monopogen.py  somatic  \
    ...
    -i /uoa/home/t05cj23/sharedscratch/main/output/ID4 -l /uoa/home/t05cj23/sharedscratch/git/ref_barcode.csv -s LDrefinement \
    -g /uoa/home/t05cj23/sharedscratch/main/hg38/chr20.fa.gz

echo "LDrefinement for ID4 complete"