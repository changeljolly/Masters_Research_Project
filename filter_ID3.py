...
# Load the datasets
df1 = pd.read_csv('/uoa/home/t05cj23/sharedscratch/main/output/ID3/somatic/chr20.putativeSNVs.csv')

# Apply the filtering criteria to both datasets
filtered_ID3 = filter_df(df1)
...
filtered_ID3.to_csv(f'{output_directory}/filtered_ID3.csv', index=False)

# Print the number of rows in the final outputs
print(f"Number of rows in filtered_ID3.csv: {filtered_ID3.shape[0]}")
